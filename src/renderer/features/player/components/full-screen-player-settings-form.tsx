...
export const FullScreenPlayerSettingsForm = () => {
    ...
    const playerOptions = [
        ...
        },
        {
            component: (
                <ListConfigBooleanControl
                    onChange={(value) => setStore({ visualizerAsBackground: value })}
                    value={!!visualizerAsBackground}
                />
            ),
            id: 'visualizerAsBackground',
            label: t('page.fullscreenPlayer.config.visualizerAsBackground', {
        ...
        },
        {
            component: (
                <ListConfigBooleanControl
                    onChange={(value) => setStore({ visualizerLyricsOverlay: value })}
                    value={visualizerLyricsOverlay !== false}
                />
            ),
            id: 'visualizerLyricsOverlay',
            label: t('page.fullscreenPlayer.config.visualizerLyricsOverlay', {
