    ...
    const lyricOptions = [
        ...
        },
        {
            component: (
                <ListConfigBooleanControl
                    onChange={(value) => {
                        updateLyricsSetting({ skipNeteasePlaceholders: value });
                        localSettings?.set('skipNeteasePlaceholders', value);
                    }}
                    value={lyricsSettings.skipNeteasePlaceholders}
                />
            ),
            ...
            id: 'skipNeteasePlaceholders',
            isHidden: !isElectron(),
            label: t('setting.skipNeteasePlaceholders', { postProcess: 'sentenceCase' }),
        },
    ];
